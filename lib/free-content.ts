...
export const freeContentResources: FreeContentResource[] = [
  {
    ...
    eyebrow: "Free Tongue Test TCM guide",
    format: "Guide",
    description:
    ...
    promise:
      "Sign up to unlock the guide and get practical educational notes on tongue observation, Traditional Chinese Medicine-inspired pattern reflection, and the Tongue Test TCM launch.",
